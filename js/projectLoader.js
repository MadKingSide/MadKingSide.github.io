...
const projectObj = {
  ...
  pixar: {
    ...
    iframe: false,
    subTitle1: "Capture d'écran du projet dans Davinci",
    image1: "../Assets/3D/Intro_Pixar/Knight_maya.jpg",
    apps: ['maya','REAPER','DaVinci'],
    lingo: false,
    isMine: true,
  ...
  odysseus: {
    ...
    iframe: false,
    subTitle1: "Capture d'écran du projet dans Autodesk Maya",
    text1: "Un des sons a été perdu lors du transfert d'un ordi à l'autre.",
